...
const Cart = () => {
  ...
  const { cart, clearCart, total, itemAmount } = useContext(CartItemContext);
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-y-2 lg:h-[460px] overflow-y-auto overflow-x-hidden border-b">
        {cart.map((item) => {
